...
export default function CarteraPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    setError(null);
    try {
      // Aquí se conectaría con el backend de Cartex
      // Por ahora dejamos datos simulados para que la UI funcione
      setReport({
        success: true,
        variables: {
          total_cartera: 12500000000,
          total_vencido: 2500000000,
          sum_monto_ini_loan_list: 15000000000,
          sum_saldo_cap_loan_list: 12000000000,
          total_vencido_loan_list: 3000000000,
        },
        data: [],
      });
      setPaymentsDetails({
        success: true,
        variables: { total_recaudos: 6890760000 },
        data: [
          { fecha: "2025-05-01", identif: "123", nombre: "Pago 1", numdoc: "001", tipo: "NORMAL", detalle: "Pago cuota", vr_pago: 2500000000, tasa_iva: 0, num_cred: "001", cod_tipocred: "CON", nom_tipocred: "Consumo", num_externo: "EXT001" },
          { fecha: "2025-05-01", identif: "124", nombre: "Pago 2", numdoc: "002", tipo: "ABONO", detalle: "Abono capital", vr_pago: 1500000000, tasa_iva: 0, num_cred: "002", cod_tipocred: "HIP", nom_tipocred: "Hipotecario", num_externo: "EXT002" },
          { fecha: "2025-05-01", identif: "125", nombre: "Pago 3", numdoc: "003", tipo: "RECUPERACION", detalle: "Recuperación cartera", vr_pago: 2890760000, tasa_iva: 0, num_cred: "003", cod_tipocred: "VEH", nom_tipocred: "Vehicular", num_externo: "EXT003" },
        ],
      });
    } catch (e: any) {
